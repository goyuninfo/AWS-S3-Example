 ...
 * (/home/ruz/.aws/credentials) where the sample code will load the credentials
 * from.
 * <p>
...
public class S3Sample {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			throw new AmazonClientException("Cannot load the credentials from the credential profiles file. "
					...
					+ "location (/home/ruz/.aws/credentials), and is in valid format.", e);
		}
	...
	private static void generatePreSignedUrl(String bucketName, String objectKey) throws IOException {
